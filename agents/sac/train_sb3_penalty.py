# Updated Nov-30
# Base config-3: train_sb3_multicore_penalty.py
...
from custom import SafetyRewardWrapper

model_name = "sac_sb3_penalty"
...
def train():
    ...
    model = SAC(
        ...
        train_freq=64, # train every 64 steps to balance learning and computation
    ...
    print("Starting Training with SB3 SAC Agent (config-3: aggressive penalty)...")
